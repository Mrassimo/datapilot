...
exports.ParsingMetadataTracker = void 0;
const csv_parser_1 = require("../../parsers/csv-parser");
const csv_detector_1 = require("../../parsers/csv-detector");
const encoding_detector_1 = require("../../parsers/encoding-detector");
const fs_1 = require("fs");
class ParsingMetadataTracker {
    warnings = [];
    parser;
    constructor(_config) {
        this.parser = new csv_parser_1.CSVParser({ autoDetect: true });
    }
    /**
     * Perform enhanced CSV parsing with detailed metadata collection
     */
    async parseWithMetadata(filePath) {
     ...
     */
    async createFileSample(filePath) {
     ...
     */
    analyzeEncoding(sample) {
        const result = encoding_detector_1.EncodingDetector.detect(sample);
        return {
     ...
     */
    analyzeDelimiter(sample) {
        const detected = csv_detector_1.CSVDetector.detect(sample);
     ...
     */
    addPerformanceWarnings(parseTimeMs, rowCount) {
...
exports.ParsingMetadataTracker = ParsingMetadataTracker;
//# sourceMappingURL=parsing-metadata-tracker.js.map