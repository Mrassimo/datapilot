    ...
    switch (task.taskType) {
      case 'regression':
        recommendations.push(
          ...this.generateRegressionRecommendations(
            task,
            section1Result,
            section3Result,
            section5Result,
      ...
      case 'multiclass_classification':
        recommendations.push(
          ...this.generateClassificationRecommendations(
            task,
            section1Result,
            section3Result,
            section5Result,
      ...
      case 'clustering':
        recommendations.push(
          ...this.generateClusteringRecommendations(
            task,
            section1Result,
            section3Result,
            section5Result,
      ...
      case 'time_series_forecasting':
        recommendations.push(
          ...this.generateTimeSeriesRecommendations(
            task,
            section1Result,
            section3Result,
            section5Result,
      ...
      case 'anomaly_detection':
        recommendations.push(
          ...this.generateAnomalyDetectionRecommendations(
            task,
            section1Result,
            section3Result,
            section5Result,
  ...
  private generateRegressionRecommendations(
    ...
    if (featureCount > 5) {
      recommendations.push({
        ...
        category: 'linear_models',
        suitabilityScore: this.calculateRegularizedRegressionSuitability(
          task,
          section3Result,
          featureCount,
        ),
  ...
  private getTreeHyperparameters(taskType: string): HyperparameterGuide[] {
    return [
      ...
      },
      {
        ...
        recommendedRange:
          taskType === 'regression' ? 'squared_error, absolute_error' : 'gini, entropy',
