 ...
 */
export type ModelingTaskType = 'regression' | 'binary_classification' | 'multiclass_classification' | 'clustering' | 'time_series_forecasting' | 'anomaly_detection' | 'survival_analysis' | 'dimensionality_reduction';
export type AlgorithmCategory = 'linear_models' | 'tree_based' | 'ensemble_methods' | 'neural_networks' | 'probabilistic_models' | 'instance_based' | 'unsupervised';
...
export interface Section6Progress {
    stage: 'initialization' | 'task_identification' | 'algorithm_selection' | 'workflow_design' | 'evaluation_framework' | 'ethics_analysis' | 'interpretation_guide' | 'finalization';
    percentage: number;
    message: string;
    currentStep: number;
    totalSteps: number;
