...
exports.UniquenessAnalyzer = void 0;
...
class UniquenessAnalyzer {
    ...
    detectSemanticDuplicates() {
        ...
        const stringColumns = this.headers
            ...
            .filter(({ type }) => type === types_1.DataType.STRING)
    ...
    calculateRowSimilarity(rowIdx1, rowIdx2, stringColumns) {
        const columnSimilarities = {};
    ...
    calculateUniquenessScore(exactDuplicates, keyUniqueness, columnUniqueness) {
        ...
        const lowUniquenessColumns = columnUniqueness.filter((col) => {
            const isKeyLike = col.columnName.toLowerCase().includes('id') || col.columnName.toLowerCase().includes('key');
    ...
    isPotentialPrimaryKey(columnName, duplicateCount, totalCount) {
...
exports.UniquenessAnalyzer = UniquenessAnalyzer;
//# sourceMappingURL=uniqueness-analyzer.js.map