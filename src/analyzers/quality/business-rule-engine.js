...
class BusinessRuleEngine {
    ...
    rules = [];
    violations = [];
    constructor(data, headers, _columnTypes, // Intentionally unused - reserved for future type-specific rules
    config = {}) {
        this.data = data;
            ...
            this.rules.push({
                ...
                validate: (row, _headers, rowIndex) => {
                    ...
                    if (state && postal) {
                        ...
                        const formatMismatch = (isUSState && !isUSZip && !isCAPostal) || (isCAProvince && !isCAPostal && !isUSZip);
                        if (formatMismatch) {
                            return {
            ...
            this.rules.push({
                ...
                validate: (row, _headers, rowIndex) => {
                    ...
                    if (diagnosis && diagnosis.length > 0) {
                        ...
                        if (!icd10Pattern.test(diagnosis) &&
            ...
            this.rules.push({
                ...
                validate: (row, _headers, rowIndex) => {
                    ...
                    if (enrollmentDate && graduationDate) {
                        ...
                        const timeDiffYears = (graduationDate.getTime() - enrollmentDate.getTime()) /
     ...
     */
    addStringFormatConsistencyRules() {
...
//# sourceMappingURL=business-rule-engine.js.map