...
export declare enum ChartPurpose {
...
export declare enum ResponsivenessLevel {
    STATIC = "static",
...
export declare enum AntiPatternType {
...
export declare enum BivariatePurpose {
...
export declare const PREDEFINED_PALETTES: Record<string, DetailedColorScheme>;
