...
class DomainAwareIntelligence {
     ...
     */
    static buildDomainKnowledge(primaryDomain, subdomains) {
        if (primaryDomain.domain === 'education') {
     ...
     */
    static buildEducationKnowledge() {
        return {
            keyMetrics: [
                {
     ...
     */
    static createVisualizationStrategy(primaryDomain, stakeholders, domainKnowledge) {
        if (primaryDomain.domain === 'education') {
     ...
     */
    static createEducationVisualizationStrategy(stakeholders, domainKnowledge) {
        return {
            primaryApproach: {
     ...
     * Generate domain-specific insights
     */
    static generateDomainInsights(primaryDomain, columnNames, dataCharacteristics) {
        const insights = [];
        if (primaryDomain.domain === 'education') {
            insights.push({
     ...
     */
    static calculateOverallConfidence(primaryDomain, contextClues, subdomains) {
     ...
     */
    static generateSemanticMappings(columnNames, domainContext) {
        const mappings = [];
        for (const column of columnNames) {
     ...
     */
    static mapColumnToSemantic(columnName, domainContext) {
        const columnLower = columnName.toLowerCase();
        if (domainContext.primaryDomain.domain === 'education') {
            // Performance outcomes
            if (columnLower.includes('score') ||
     ...
     */
    static analyzeDataContext(columnNames, dataCharacteristics) {
...
exports.DomainAwareIntelligence = DomainAwareIntelligence;
//# sourceMappingURL=domain-aware-intelligence.js.map