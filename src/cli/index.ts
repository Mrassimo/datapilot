...
export class DataPilotCLI {
  ...
  private formatUniversalReport(
    ...
    report += `**DataPilot Version**: 1.2.0 (Multi-Format Edition)\n\n`;
    ...
    report += `**Generated by DataPilot v1.2.0** - Universal Data Analysis Engine\n`;
  ...
  private generateComprehensiveReport(
    ...
    report += `**DataPilot Version**: v1.2.0 (TypeScript Edition)\n`;
    ...
    report += `---\n\n`;
    report += `**Generated by DataPilot v1.2.0**\n`;
